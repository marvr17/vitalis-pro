...
export default function AddEmployeeModal({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-3 md:p-4 z-50">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-[95vw] md:max-w-md max-h-[95vh] overflow-y-auto">
        {/* Header */}
        <div className="sticky top-0 bg-white border-b border-gray-200 px-4 md:px-6 py-3 md:py-4 flex items-center justify-between rounded-t-2xl">
          <h2 className="text-xl md:text-2xl font-bold text-gray-900">Agregar Empleado</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-4 md:p-6">
          {error && (
            <div className="mb-4 p-3 md:p-4 bg-red-50 border border-red-200 rounded-lg text-red-600 text-sm">
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-3 md:space-y-4">
            ...
            <div>
              <label htmlFor="department" className="block text-sm font-medium text-gray-700 mb-1.5 md:mb-2">
                Departamento
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="position" className="block text-sm font-medium text-gray-700 mb-1.5 md:mb-2">
                Puesto
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="startDate" className="block text-sm font-medium text-gray-700 mb-1.5 md:mb-2">
                Fecha de ingreso
              </label>
              <input
                type="date"
