...
export default function DemoSettingsPage({ params }: { params: { orgSlug: string } }) {
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="email"
                    defaultValue="contacto@demo-empresa.com"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="url"
                    defaultValue="https://demo-empresa.com"
                    className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-transparent"
                    disabled
                  />
                </div>
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">admin@demo-empresa.com</p>
                  </div>
                </div>
          ...
          <Card className="shadow-lg border-l-4 border-l-yellow-500">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Modo Demo</h4>
                  <p className="text-sm text-gray-600">
                    Estás en modo demostración. Los cambios no se guardarán. Crea una cuenta real
